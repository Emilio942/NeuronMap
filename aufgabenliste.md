...
- [x] **Paper vollständig durcharbeiten**
  - [x] PDF herunterladen und alle Sektionen lesen
  - [x] Architektur-Diagramme extrahieren und dokumentieren
  - [x] Algorithmen und Pseudo-Code analysieren
  - [x] Benchmarks und Evaluationsergebnisse verstehen

- [x] **Technische Details dokumentieren**
  - [x] Switch-Mechanismus zwischen latent/explicit Reasoning verstehen
  - [x] Entropie-basierte Konfidenz-Berechnung nachvollziehen
  - [x] Block-wise Confidence Estimation dokumentieren
  - [x] Maximum Switch-Limit Strategie analysieren

### 1.2 Architektur-Vergleich
- [x] **Unterschiede zu Standard-Transformern identifizieren**
  - [x] Neue Layer-Typen oder Modifikationen
  - [x] Spezielle Attention-Mechanismen
  - [x] Latent Space Reasoning Module
  - [x] Switching Logic Components

- [x] **Visualisierungsanforderungen definieren**
  - [x] Welche neuen Visualisierungen werden benötigt?
  - [x] Wie können Switches visualisiert werden?
  - [x] Wie zeigt man latentes vs. explizites Reasoning?
  - [x] Entropie-Trends visuell darstellen

### 1.3 Muster-Analyse
- [x] **Reasoning-Patterns identifizieren**
  - [x] Typische Switch-Patterns dokumentieren
  - [x] Erfolgreiche vs. problematische Reasoning-Pfade
  - [x] Overthinking-Patterns erkennen
  - [x] Optimale Token-Budgets für verschiedene Problemtypen
...
- [x] **Entropie-Berechnung implementieren**
  - [x] Next-token Distribution Entropy berechnen
  - [x] Block-wise Confidence aus Entropie-Trends ableiten
  - [x] Confidence Thresholds für Switching konfigurierbar machen

- [x] **Metrics-System erweitern**
  - [x] Token-Effizienz pro Block tracken (via ThinkingBlock)
  - [x] Switch-Häufigkeit messen (via SwiReasoningTrace)
  - [x] Overthinking Detection Metrics (via Entropy Trend)

---

## Phase 3: Guardian Policy Integration (Woche 5-7)

### 3.1 SwiReasoning Policy
- [x] **Policy Implementation (`src/guardian/policies.py`)**
  - [x] `SwiReasoningPolicy` Klasse erstellen
  - [x] Integration von `SwiReasoningTrace`
  - [x] Implementierung der Switch-Logik (Entropy-basiert)
  - [x] Integration in `PolicyManager`

### 3.2 Inference-Tracing & Visualisierung
- [x] **Runtime-Monitoring implementieren**
  - [x] Hook-System für Inference-Time Tracing (Guardian Engine)
  - [x] Block-Transitions aufzeichnen (Policy)
  - [x] Echtzeit-Entropie Berechnung (Probes)
  - [x] Switch-Decisions loggen (Policy)

- [x] **Frontend-Integration**
  - [x] Visualisierung des aktuellen Modus (Latent/Explicit)
  - [x] Echtzeit-Graph für Entropie-Trend
  - [x] Anzeige der Switch-Gründe
